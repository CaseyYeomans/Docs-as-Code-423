# Configuring MatchRecord Activities

The MatchRecord activity in a workflow processes a matching strategy for the record referenced in the golden record data context.

To configure a Match Record activity:
...
3. Select the Match Record activity you want to configure.
...
4. Select the name of the matching strategy to process for the referenced record.

6. Click **Save** to apply changes to the activity.
