...
2. Click the **Monitor** tab under **Operations** in the leftmost pane.

![](https://Profisee.magentrixcloud.com/sys/staticasset/read/file-iaea102d92c410473.png)

  From here, the Activity Monitor zone displays the following information:

* **Name**: The Name of the activity being monitored
* **Activity Type**: The Type of activity being monitored
