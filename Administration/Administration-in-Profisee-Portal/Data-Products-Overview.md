...
> [!NOTE]
> For example: A user creates two Data Products labeled Company and Customer in an instance with two entities labeled Product and Currency . That user could associate the Currency entity with both Data Products, but could associate the Product entity with only the Company Data Products. Product Entity Currency Entity Company Data Product ✓ ✓ Customer Data Product X ✓
