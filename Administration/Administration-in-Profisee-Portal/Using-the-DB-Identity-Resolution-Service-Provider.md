...
This tab allows you to map Request Properties onto existing Attributes, or use the Aisey-powered **Assist** button to either automatically suggest mappings onto existing attributes, or create new attributes and mappings that match the Request properties. If there is not an appropriate attribute to use for request mapping, you can create a new attribute using the **+** button.

You can also create expressions using the [expression editor](https://support.profisee.com/wikis/profiseeplatform/using_the_expression_editor_in_portal) to define a customer attribute with specific parameters.  
  
  
![](https://Profisee.magentrixcloud.com/sys/staticasset/read/file-i7b8a62f12f74d670.png)

### Response

#### Mapping Default Response to Customer

This tab allows you to map Response Properties onto existing Attributes, or use the Aisey-powered **Assist** button to either automatically suggest mappings onto existing attributes, or create new attributes and mappings that match the Response properties. If there is not an appropriate attribute to use for request mapping, you can create a new attribute using the **+** button.

You can also create expressions using the [expression editor](https://support.profisee.com/wikis/profiseeplatform/using_the_expression_editor_in_portal) to define a response property with specific parameters.![](https://Profisee.magentrixcloud.com/sys/staticasset/read/file-id5eaf34900552ac7.png)
