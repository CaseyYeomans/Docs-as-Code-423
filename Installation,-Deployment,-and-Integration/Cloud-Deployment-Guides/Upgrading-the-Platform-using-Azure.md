# Upgrading the Platform using Azure

If you want to upgrade to a new version of the Profisee Platform, you can upgrade your AKS-deployed instance through the Azure portal or through Azure Cloud Shell. To do so, you must have permissions to edit the settings of the Kubernetes Service resource in your cluster.
...
Click [here](https://support.profisee.com/wikis/profiseeplatform/deploying_the_AKS_cluster_with_the_arm_template) for a detailed deployment guide for Profisee ver. 2022R2 and [here](https://support.profisee.com/lms/courseinfo?id=00u00000000002b00aM&mode=browsecourses) for video training course and slide deck. (The process is similar for later releases.)
...
4. To run the Histroy tables upgrade please follow the steps as outlined [here](https://support.profisee.com/wikis/profiseeplatform/upgrade_considerations_and_prerequisites)
...
5. To run the Histroy tables upgrade please follow the steps as outlined [here](https://support.profisee.com/wikis/profiseeplatform/upgrade_considerations_and_prerequisites)
