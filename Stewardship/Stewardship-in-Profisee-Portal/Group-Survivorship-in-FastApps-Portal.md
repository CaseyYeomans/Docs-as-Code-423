...
1. Open the [Match Cluster control](https://support.profisee.com/wikis/profiseeplatform/accessing_match_cluster_controls) for the desired Match Cluster and navigate to the Survivorship tab.
...
3. Survivorship runs for the currently displayed cluster. A **Processing**message window displays. Additional actions cannot be performed until processing is complete.
...
* If the cluster had no golden record before, a golden record may be created if specified in the strategy (see note below).
